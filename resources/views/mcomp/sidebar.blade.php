...
<div class="flex flex-col relative my-1 cursor-pointer">
    <a href="/manager/jobreq" class="ml-8 flex p-1 w-full rounded-xl sidebar-link {{ Request::is('manager/jobreq') ? 'active' : '' }}">
        <span class="flex items-center gap-1 px-1">
            ...
            <span class="text-lg">Job Requisition</span>
        </span>
    </a>
</div>
            ...
            <a href="/manager/onboardingm" class="ml-8 flex p-1 w-full rounded-xl sidebar-link {{ Request::is('manager/onboardingm') ? 'active' : '' }}">
                    <span class='flex items-center gap-1 px-1'>
            ...
            <div class='flex relative my-1 cursor-pointer'>
            <a href="/manager/recruitm" class="ml-8 flex p-1 w-full rounded-xl sidebar-link {{ Request::is('manager/recruitm') ? 'active' : '' }}">
                    <span class='flex items-center gap-1 px-1'>
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" class="icon icon-tabler icons-tabler-filled icon-tabler-layout-dashboard">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                            <path d="M9 3a2 2 0 0 1 2 2v6a2 2 0 0 1 -2 2h-4a2 2 0 0 1 -2 -2v-6a2 2 0 0 1 2 -2zm0 12a2 2 0 0 1 2 2v2a2 2 0 0 1 -2 2h-4a2 2 0 0 1 -2 -2v-2a2 2 0 0 1 2 -2zm10 -4a2 2 0 0 1 2 2v6a2 2 0 0 1 -2 2h-4a2 2 0 0 1 -2 -2v-6a2 2 0 0 1 2 -2zm0 -8a2 2 0 0 1 2 2v2a2 2 0 0 1 -2 2h-4a2 2 0 0 1 -2 -2v-2a2 2 0 0 1 2 -2z" />
            ...
            <div class='flex relative my-1 cursor-pointer'>
            <a href="/manager/applicantm" class="ml-8 flex p-1 w-full rounded-xl sidebar-link {{ Request::is('manager/aplicantm') ? 'active' : '' }}"onclick="setActiveLink(this)">
                    <span class='flex items-center gap-1 px-1'>
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" class="icon icon-tabler icons-tabler-filled icon-tabler-layout-dashboard">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                            <path d="M9 3a2 2 0 0 1 2 2v6a2 2 0 0 1 -2 2h-4a2 2 0 0 1 -2 -2v-6a2 2 0 0 1 2 -2zm0 12a2 2 0 0 1 2 2v2a2 2 0 0 1 -2 2h-4a2 2 0 0 1 -2 -2v-2a2 2 0 0 1 2 -2zm10 -4a2 2 0 0 1 2 2v6a2 2 0 0 1 -2 2h-4a2 2 0 0 1 -2 -2v-6a2 2 0 0 1 2 -2zm0 -8a2 2 0 0 1 2 2v2a2 2 0 0 1 -2 2h-4a2 2 0 0 1 -2 -2v-2a2 2 0 0 1 2 -2z" />
