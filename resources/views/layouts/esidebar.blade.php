    ...
    <aside class="w-80 hidden md:flex md:flex-col border m-4 mr-0 rounded-lg overflow-hidden">
      ...
      <div class="flex flex-col mr-4">
        ...
        <a href="#home" class="ml-8 flex p-1 w-full rounded-xl  sidebar-link" onclick="setActiveLink(this)" onclick="loadSection('home')">
        ...
        <div class='flex relative my-1 cursor-pointer'>
          <a href="" class="ml-8 flex p-1 w-full rounded-xl  sidebar-link" onclick="setActiveLink(this)">
            <span class='flex items-center gap-1 px-1'>
        ...
        <div class='flex relative my-1 cursor-pointer'>
          <a href="" class="ml-8 flex p-1 w-full rounded-xl  sidebar-link" onclick="setActiveLink(this)">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                ...
                <span class="text-lg">Learnings</span>
            </span>
          </a>
        </div>
